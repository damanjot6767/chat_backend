...
router.route('/by-chat-id/:id').get(auth_middleware_1.verifyJWT, get_message_validation_1.GetMessageByIdParamJoiValidation, message_controller_1.getMessagesByChatId);
