...
const chat_redis_service_1 = require("./chat-redis-service");
...
const getChatById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isCache = yield (0, chat_redis_service_1.getChatByIdRedis)(id);
        if (isCache)
            return isCache;
        const response = yield exports.ChatModel.findOne({ _id: id });
        yield (0, chat_redis_service_1.setChatByIdRedis)(response);
        return response;
    }
    catch (error) {
        throw new api_error_1.ApiError(500, "Something went wrong while finding chat by id");
