...
const getMessagesByChatId = (id, page = 1, limit = 10) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isCacheMessages === null || isCacheMessages === void 0 ? void 0 : isCacheMessages.length)
...
const createManyMessage = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isCache = yield (0, message_redis_service_1.pushMessageRedis)(payload);
        const isCacheMessages = yield (0, message_redis_service_1.pullMessageRedis)(payload === null || payload === void 0 ? void 0 : payload.chatId);
        if ((isCacheMessages === null || isCacheMessages === void 0 ? void 0 : isCacheMessages.length) >= 100) {
            const response = yield exports.MessageModel.insertMany(isCacheMessages);
            yield (0, message_redis_service_1.deleteMessagesRedis)(payload === null || payload === void 0 ? void 0 : payload.chatId);
            return response;
        }
        return isCache;
    }
